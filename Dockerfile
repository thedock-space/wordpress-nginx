...
RUN chown -R 1001:root /bitnami && chown -R 1001:root /certs && chown -R 1001:root /opt/bitnami/php && chown -R 1001:root /opt/bitnami/nginx && chown 1001:root /opt/bitnami/wordpress/wp-content && chown 1001:root /opt/bitnami/wordpress/wp-config.php && chown 1001:root /usr/local/share/ca-certificates/ && chown 1001:root /etc/ssl/certs/ && rm -r -d -f /opt/bitnami/wordpress/wp-content/uploads/*
EXPOSE 8080 8443
USER 1001
